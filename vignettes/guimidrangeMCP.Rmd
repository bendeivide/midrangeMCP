...
#### Variable Response
A Variável Resposta é para o caso em que o pesquisador nao queira fornecer o conjunto de dados na íntegra, e sim alguns dados específicos para a análise. Neste caso apenas é repassado o conjunto de dados, de acordo com o que estamos trabalhando aqui como exemplo, em que o objeto é o TRAT(tratamento) e PROD(variável resposta). Sendo assim apenas o valor de grau de liberdade e quadrado médio terão que ser inseridos.
...
Esta função traz a possibilidade de atualização de três componentes relacionados ao gráfico.

#### Color
O primeiro componente é a mudança de cor que pode ser mudada para cinza com o seguinte comando ’gray.color(4)’, por exemplo.


#### Horizontal
Já o segundo componente é a mudança de sentido dos eixos do gráfico sendo ela na Vertical (padrão) ou Horizontal, definindo isso com o comando de ’FALSE’ ou ’TRUE’.

#### Axes
O terceiro componente é a opção de nomear os eixos do gráfico e isso é feito com o seguinte comando ’xlab = “VR”; ylab = “Tratamento”’, sendo o xlab responsável por nomear o eixo X e o ylab pelo o eixo Y.
