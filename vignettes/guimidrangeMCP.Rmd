...
### 7th Extension 
A extensão é o tipo de arquivo que será exportado os resultados e seguirá para o caminho do 1º passo. Os tipos de arquivos são: latex, txt, xlsx. Escolha de acordo com a sua necessidade de formato para a análise. Nota: os dados da escolha da extensão Latex será mostrado no Console para que o uso do mesmo seja copiado e colado no documento.

### 8th Level of insignificance
O nível de significância para análise é colocado aqui, sendo em um intervalo entre 0 e 1.Como padrão o valor 0.05 já é inserido.
