...
```
<h1 id="titulo">About the functions of the midrangeMCP package  </h1>
...
if (op==0){
 document.querySelector("#titulo").innerHTML = "Sobre as funções do pacote midrangeMCP"
...
if (op==1){
 ...
 document.querySelector("#titulo").innerHTML = "About the functions of the midrangeMCP package"
