...
4. Se $\mid \overline{r}_n \mid \leq \Delta_n $, então as $n$ médias serão consideradas não diferentes. Caso contrário, vai para o passo 5, considerando $m = n$ médias;
...
8. Para cada grupo obtido e marcado como divisível, considere m o número de médias
...
10. Repete-se o processo para todos os $l$ grupos de $m$ médias, refazendo-se os passos
